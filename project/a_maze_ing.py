...
#     context.mlxbinding.mlx_key_hook(viewport.viewport_ptr, key_handler_factory, [context, viewport, img, renderer, sol_path, update])
...
def render_maze(configurationfile: str, context: MlxContext) -> None:
    try:
...
def main() -> None:
    ...
    render_maze(configurationfile, context)
